...
<sql:query dataSource="${conexao}" var="r">
    SELECT fil_codigo, fil_titulo FROM filmes WHERE fil_titulo like '%${where}%' ORDER BY ${order_by} LIMIT ${inicio}, ${exiba};
</sql:query>
...
<div class="col-sm-9 col-sm-offset-3 col-md-12 col-md-offset-2 main">
	...
	<div class="col-md-3 mt-3"><h2>Filme</h2></div>
            ...
            <div class="col-md-3 mt-3">
                    <a href="../Incluir/index.jsp" class="btn btn-primary pull-right h2">Inserir Filme</a>
            </div>
        </div>			
                            ...
                            <tbody>
                                <c:forEach var="i" items="${r.rows}">
                                    <tr>
                                        ...
                                        <td class='actions'>
                                            <a href="../Alterar/index.jsp?id=<c:out value="${i.fil_codigo}"/>" class="btn btn-xs btn-warning">Editar</a>
                                            <a href="javascript:confirmacao('Deseja apagar o filme?',
                                                     '../Excluir/index.jsp?id=<c:out value="${i.fil_codigo}"/>')"
                                                     class="btn btn-xs btn-danger">Excluir</a>
                                            <a href="../../AtorFilme/Menu/index.jsp?fil=<c:out value="${i.fil_codigo}"/>" class="btn btn-xs btn-primary">Ator</a>
                                        </td>
                                    </tr>
                                </c:forEach>    
                            </tbody>
