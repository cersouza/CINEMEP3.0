                ...
                <c:if test="${sessionScope.Usu_Perfil == 3}">
                  ...
                  <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="admin">
                            <a class="dropdown-item" href="../../Ator/Menu/index.jsp">Ator</a>
                            <a class="dropdown-item" href="../../Classificacao/Menu/index.jsp">Classificação</a>
                            <a class="dropdown-item" href="../../Distribuidora/Menu/index.jsp">Distribuidora</a>
                            <a class="dropdown-item" href="../../Filme/Menu/index.jsp">Filme</a>
                            <a class="dropdown-item" href="../../Genero/Menu/index.jsp">Genero</a>
                            <a class="dropdown-item" href="../../Usuario/Menu/index.jsp">Usuario</a>
                        </div>
                  </li>
                </c:if>
