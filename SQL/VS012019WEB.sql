...
--
-- Host: 127.0.0.1
-- Generation Time: 22-Nov-2019 às 06:05
...
INSERT INTO `filmes` (`Fil_Codigo`, `Fil_Titulo`, `Fil_Sinopse`, `Fil_Foto`, `Fil_Lancamento`, `Fil_Tempo`, `Fil_Genero`, `Fil_Classificacao`, `Fil_Distribuidora`, `Fil_Situacao`, `Fil_Wallpaper`) VALUES
(1, 'Capita Marvel', 'Carol Danvers (Brie Larson) é uma ex-agente da Força Aérea norte-americana, que, sem se lembrar de sua vida na Terra, é recrutada pelos Kree para fazer parte de seu exército de elite. Inimiga declarada dos Skrull, ela acaba voltando ao seu planeta de origem para impedir uma invasão dos metaformos, e assim vai acabar descobrindo a verdade sobre si, com a ajuda do agente Nick Fury (Samuel L. Jackson) e da gata Goose.', 'img/filmes/capa-capita-marvel.jpg', '2019-03-07', '2h10', 1, 1, 1, 'Cartaz', 'img/filmes/wallpaper-capita-marvel.jpg'),
(2, 'Vingadores Ultimato', 'ApÃ³s Thanos eliminar metade das criaturas vivas, os Vingadores precisam lidar com a dor da perda de amigos e seus entes queridos. Com Tony Stark (Robert Downey Jr.) vagando perdido no espaÃ§o sem Ã¡gua nem comida, Steve Rogers (Chris Evans) e Natasha Romanov (Scarlett Johansson) precisam liderar a resistÃªncia contra o titÃ£ louco', 'img/filmes/vingadores-ultimato.jpeg', '2019-04-25', '03:01', 1, 2, 1, 'Ativo', 'img/filmes/wallpaper-vingadores-ultimato.jpg'),
(3, 'Homem-Aranha: Longe de Casa', 'Peter Parker (Tom Holland) estÃ¡ em uma viagem de duas semanas pela Europa, ao lado de seus amigos de colÃ©gio, quando Ã© surpreendido pela visita de Nick Fury (Samuel L. Jackson). Convocado para mais uma missÃ£o herÃ³ica, ele precisa enfrentar vÃ¡rios vilÃµes que surgem em cidades-sÃ­mbolo do continente, como Londres, Paris e Veneza, e tambÃ©m a apariÃ§Ã£o do enigmÃ¡tico Mysterio (Jake Gyllenhaal).', 'img/filmes/spider-man.jpeg', '2019-07-04', '2:30', 4, 1, 1, 'Ativo', 'img/filmes/wallpaper-spider-man.jpeg');
